export default function Website() {
	return (
		<div className="space-y-4">
			...
			<p>This website was created with a stack of React JS, Next JS, and TailwindCSS. I've made extensive use of <a className="text-primary-600 visited:text-purple-400" href="https://react-icons.github.io/react-icons"><code>react-icons</code></a> for the icons on the navgiation bar. Special thanks to Maggie Liu for the wonderful <a className="text-primary-600 visited:text-purple-400" href="https://reactive-comments-docs.vercel.app/">Reactive</a> widget for powering my blog comments!</p>
