...
export default function nature({ data }) {
    ...
    return (
        ...
        <p>Below you'll find pictures I take of my garden or things I find in nature. They're grouped roughly by what they are, although the landscapes category is just pictures of scenery. Click view to well, view them! </p>
